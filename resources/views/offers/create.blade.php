...
@section('content')
	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			...
			{!! Form::open(array('route'=>'offer.store', 'data-parsley-validate' => '','files' =>true)) !!}
				...
				{{ Form::submit('Create Offer', array('class' => 'btn btn-success btn-lg btn-block top-margin-space')) }}
