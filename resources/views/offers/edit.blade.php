...
<div class="container">
	<div class="row">
			...
			<hr>
			<div class="col-md-8">
			{!! Form::model($offer,['route' => ['offer.update', $offer->id],'data-parsley-validate'=>'', 'method' =>'PUT','files'=> true]) !!}
				...
				{!! Form::text('discount_percent', null, [
	              ...
	              'data-parsley-required-message' => 'Discount Percentage is required',
	              'data-parsley-trigger'          => 'change focusout',
	              'data-parsley-maxlength'        => '250'
	              ]) !!}
			...
			<div class="col-md-4">
				<div class="well">
					<dl class="dl-horizontal">
						<dt>Create At:</dt>
						<dd>{{ date('M j, Y h:ia', strtotime($offer->created_at)) }}</dd>
					</dl>

					<dl class="dl-horizontal">
						<dt>Last Updated:</dt>
						<dd>{{ date('M j, Y h:ia', strtotime($offer->updated_at)) }}</dd>
					</dl>
					<hr>
					<div class="row">
						<div class="col-sm-6">
							{!! Html::linkRoute('offers.index', 'Cancel', array($offer->id), array('class' => 'btn btn-danger btn-block')) !!}
						</div>
						<div class="col-sm-6">
